...
import { detectEmailTypo, type EmailTypoSuggestion } from "@/lib/email-typo-detector";
...
export default function RegisterPage() {
  ...
  const [emailTypoSuggestion, setEmailTypoSuggestion] = useState<EmailTypoSuggestion | null>(null);
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {emailTypoSuggestion && emailExists !== true && (
                      <div className="mt-1 text-xs text-amber-600 flex items-start gap-1">
                        ...
                        <span>
                          ...
                          <button
                            type="button"
                            onClick={() => setEmail(emailTypoSuggestion.suggested)}
