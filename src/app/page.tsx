    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <div className="flex items-center gap-6">
                <a href="#features" className="text-gray-600 hover:text-gray-900 font-medium transition-colors hidden md:block">
                  Features
                </a>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-green-50 via-white to-green-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          ...
          <a
            href="/register"
                  className="group bg-gradient-to-r from-green-500 to-green-600 text-white text-lg px-8 py-4 rounded-xl font-semibold hover:shadow-xl transition-all duration-200 shadow-lg transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
          >
                  Start Free Trial
          ...
          <a
                  href="#demo"
                  className="border-2 border-gray-300 text-gray-700 text-lg px-8 py-4 rounded-xl font-semibold hover:border-green-500 hover:bg-green-50 transition-all duration-200 flex items-center justify-center gap-2"
                >
      ...
      <div className="py-20 bg-gray-50">
        ...
        <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">You've worked too hard to lose your recipes</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 text-center text-white">
            ...
            <div>
              ...
              <div className="text-emerald-100">Recipes Managed</div>
            </div>
            <div>
              <div className="text-5xl font-bold mb-2">£2M+</div>
              <div className="text-emerald-100">Costs Tracked</div>
            </div>
            <div>
      ...
      <div className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Loved by food professionals</h2>
            <p className="text-xl text-gray-600">See why kitchens are switching to Plato</p>
          </div>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Be up and running in under 5 minutes</p>
          </div>

          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="relative inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl shadow-lg mb-6">
                <span className="text-3xl font-bold text-white">1</span>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Add Your Ingredients</h3>
            ...
            <div className="text-center">
              <div className="relative inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl shadow-lg mb-6">
                <span className="text-3xl font-bold text-white">2</span>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Build Your Recipes</h3>
              <p className="text-gray-600 text-lg">
            ...
            <div className="text-center">
              <div className="relative inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl shadow-lg mb-6">
                <span className="text-3xl font-bold text-white">3</span>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Add Your Team</h3>
              <p className="text-gray-600 text-lg">
      ...
      {/* Final CTA */}
      <div className="py-24 bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <a
                  href="/register"
              className="group bg-white text-emerald-600 px-10 py-5 rounded-xl font-bold text-lg hover:bg-gray-50 transition-all duration-200 shadow-xl hover:shadow-2xl transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
                >
              ...
              <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
              href="/pricing"
              className="border-2 border-white text-white px-10 py-5 rounded-xl font-bold text-lg hover:bg-white/10 transition-all duration-200"
                >
              View Pricing
                </a>
              </div>
