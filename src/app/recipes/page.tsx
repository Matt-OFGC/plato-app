  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8 flex items-center justify-between">
        ...
        <Link href="/recipes/new" className="bg-[var(--primary)] text-[var(--primary-foreground)] px-6 py-3 rounded-xl hover:bg-[var(--accent)] transition-colors font-medium flex items-center gap-2">
      ...
      {recipes.length === 0 ? (
        <div className="text-center py-16">
          ...
          <Link href="/recipes/new" className="bg-[var(--primary)] text-[var(--primary-foreground)] px-6 py-3 rounded-xl hover:bg-[var(--accent)] transition-colors font-medium">
            Create Recipe
          </Link>
        </div>
      ) : (
