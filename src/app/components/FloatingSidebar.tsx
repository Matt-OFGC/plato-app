...
export function FloatingSidebar({ isOpen, onClose }: FloatingSidebarProps) {
  ...
  // Health & Safety items (placeholder for now)
  const healthSafetyItems: typeof navigationItems = [];
              ...
              <div className="px-2 py-2">
                ...
                {expandedSections.teams && (
                  <div className="mt-1 space-y-0.5">
                    ...
                    {/* Health & Safety placeholder items */}
                    {healthSafetyItems.length === 0 && !searchTerm.trim() && (
                      <div className="px-2 py-1.5 text-sm text-gray-400 italic">
                        Coming soon...
                      </div>
                    )}
