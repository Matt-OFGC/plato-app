      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4">
              <button
                onClick={() => signIn("google", { callbackUrl: sp.get("redirect") || "/" })}
                className="w-full flex justify-center items-center gap-3 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
              >
